import { calculateWorkerMatchScore } from '../../utils/matching';
...
describe('calculateWorkerMatchScore', () => {
    it('gives high score for exact skill match and within budget', () => {
        ...
        const score = calculateWorkerMatchScore(worker, workerLocation, criteria, criteriaLocation);
    ...
    it('respects weight overrides (increases skill weight)', () => {
        ...
        const baseScore = (require('../../utils/matching').calculateWorkerMatchScore as any)(worker, workerLocation, { ...criteria, weights: undefined }, criteriaLocation);
        const weightedScore = (require('../../utils/matching').calculateWorkerMatchScore as any)(worker, workerLocation, criteria, criteriaLocation);

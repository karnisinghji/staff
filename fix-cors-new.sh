#!/bin/bash
# Script to fix CORS settings on Railway deployed services
...
update_cors_for_service() {
    ...
    # Select service
    echo -e "${YELLOW}Select ${service} when prompted${NC}"
...
for service in "${SERVICES[@]}"; do
    ...
    echo -e "${YELLOW}When prompted, select the ${service} project and service${NC}"
